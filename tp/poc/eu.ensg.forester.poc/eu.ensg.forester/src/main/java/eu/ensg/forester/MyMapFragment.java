...
public class MyMapFragment extends SupportMapFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup group, Bundle bundle) {
        View view;
        // TODO !!!! Invoquer le onCreateView de la super class, sinon exception
        ...
        this.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                createCustomInfoWindow(inflater, googleMap);

                // TODO !!!! Récupère l'instance de l'objet google map et lance le custom event.
                MyMapFragment.this.googleMap = googleMap;
